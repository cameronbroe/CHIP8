...
#define VIDEO_WIDTH_SCALE 20
#define VIDEO_HEIGHT_SCALE 20

#define RAYLIB_WIDTH (VIDEO_WIDTH * VIDEO_WIDTH_SCALE)
#define RAYLIB_HEIGHT (VIDEO_HEIGHT * VIDEO_HEIGHT_SCALE)
